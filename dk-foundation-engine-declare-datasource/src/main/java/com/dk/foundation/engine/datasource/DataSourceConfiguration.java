...
import com.dk.foundation.engine.datasource.dynamicdatasource.DataSourceUtil;
import com.dk.foundation.engine.datasource.dynamicdatasource.DynamicDataSourceConfiguration;
    ...
    private void setDataSourceMap(final Environment environment) {
        ...
        for (String each : dataSources.split(",")) {
            try {
                ...
                throw new BeanInitializationException("Can't find datasource type!");
            }
        }
    }
